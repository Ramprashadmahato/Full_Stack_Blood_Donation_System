  ...
  useEffect(() => {
    const fetchDonations = async () => {
      ...
      try {
        ...
        // If backend returns { donors: [...] }
        const donorArray = res.donors || [];

        if (donorArray.length === 0) {
          setError("❌ No donation history found for your account.");
        }

        const formatted = donorArray.map((d) => ({
          id: d._id,
          name: d.name,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="bg-red-500 text-white py-16 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-2">My Donation Reports</h1>
        <p className="text-lg md:text-xl max-w-2xl mx-auto">
          Track all your blood donations and see your impact in the community.
        </p>
      </section>
